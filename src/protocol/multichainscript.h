...
#ifndef FLOATCHAINSCRIPT_H
#define	FLOATCHAINSCRIPT_H

#include "utils/declare.h"

#define FC_SCR_TYPE_SCRIPTPUBKEY                      0
#define FC_SCR_TYPE_SCRIPTSIG                         1
#define FC_SCR_TYPE_SCRIPTSIGRAW                      2

#define FC_SCR_ASSET_SCRIPT_TYPE_TRANSFER              0x00000001
#define FC_SCR_ASSET_SCRIPT_TYPE_FOLLOWON              0x00000002


typedef struct FC_Script
{    
    int m_Size;
    int m_NumElements;
    ...
    int GetAssetQuantities(FC_Buffer *amounts,uint32_t script_type);
    int SetAssetQuantities(FC_Buffer *amounts,uint32_t script_type);

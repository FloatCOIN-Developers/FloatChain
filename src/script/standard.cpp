...
//        const CScript& script2 = tplate.second;
        ...
        for(int d=0;d<=FCP_STD_OP_DROP_COUNT;d++)
        {
/* FCHN END*/        
...
/* FCHN START */        
                if(d)
                {
//                    LogPrint("FChnminor","FChn: %d OP_DROP element(s) found in script\n",d);
                }
/* FCHN END */        
                return true;
            }
...
bool IsStandard(const CScript& scriptPubKey, txnouttype& whichType)
{
    ...
    max_op_drops=FCP_STD_OP_DROP_COUNT;

...
void FloatchainNode_AddSignatureToCache(const std::vector<unsigned char>& vchSig, const CPubKey& pubkey, const uint256& sighash);
...
/* FCHN START */    
/*    
    if(FC_gState->m_Permissions->CanSend(NULL,(unsigned char*)(&address)) == 0)
    {
        return false;
    }
 */ 
/* FCHN END */    
    ...
    {
        FloatchainNode_AddSignatureToCache(vchSig,key.GetPubKey(),hash);
    }

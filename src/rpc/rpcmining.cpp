...
Value prioritisetransaction(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "Transaction prioritization is not supported in this version of FloatChain");        
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "getblocktemplate is not supported in this version of FloatChain");        
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "FloatChain is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "FloatChain is downloading blocks...");

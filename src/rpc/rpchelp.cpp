...
std::string FC_RPCHelpString(std::string strMethod)
{
    string strHelp="";
...
void FC_InitRPCHelpMap01()
{
    ...
    mapHelpStrings.insert(std::make_pair("getblockchaininfo",
            ...
            "  \"chainname\": \"xxxx\",              (string) floatchain network name\n"
            "  \"description\": \"xxxx\",            (string) network desctription\n"
            "  \"protocol\": \"xxxx\",               (string) protocol - floatchain or bitcoin\n"
...
void FC_InitRPCHelpMap03()
{
    ...
    mapHelpStrings.insert(std::make_pair("stop",
             "stop\n"
            "\nShuts down the this blockchain node. Sends stop signal to FloatChain server."
        ));
...
void FC_InitRPCHelpMap04()
{
    ...
    mapHelpStrings.insert(std::make_pair("getaddednodeinfo",
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:8333\",  (string) The FloatChain server host and port\n"
    ...
    mapHelpStrings.insert(std::make_pair("getpeerinfo",
            ...
            "    \"handshakelocal\": n,            (string) If protocol is Floatchain. Address used by local node for handshake.\n"
            "    \"handshake\": n,                 (string) If protocol is Floatchain. Address used by remote node for handshake.\n"
...
void FC_InitRPCHelpMap07()
{
    ...
    mapHelpStrings.insert(std::make_pair("dumpprivkey",
            ...
            "\nArguments:\n"
            "1. \"address\"                        (string, required) The FloatChain address for the private key\n"
            "\nResult:\n"
...
void FC_InitRPCHelpMap09()
{
    ...
    mapHelpStrings.insert(std::make_pair("grant",
            ...
            + HelpRequiringPassphraseWrapper() +
            "\nArguments:\n"
            "1. \"address(es)\"                    (string, required)  The floatchain addresses to send to (comma delimited)\n"
    ...
    mapHelpStrings.insert(std::make_pair("grantfrom",
            ...
            "2. \"to-address(es)\"                 (string, required) The floatchain addresses to grant permissions to\n"
...
void FC_InitRPCHelpMap10()
{
    ...
    mapHelpStrings.insert(std::make_pair("grantwithdatafrom",
            ...
            "\nArguments:\n"
            "1. \"from-address\"                   (string, required) Address used for grant.\n"
            "2. \"address(es)\"                    (string, required) The floatchain addresses to send to (comma delimited)\n"
            "3. \"permission(s)\"                  (string, required) Permission strings, comma delimited. \n"
            "                                                       Global: " + AllowedPermissions() + " \n"
            "                                                       or per-asset: asset-identifier.issue,admin \n"
            "                                                       or per-stream: stream-identifier.write,activate,admin \n"
...
void FC_InitRPCLogParaFCountMap()
{
    mapLogParaFCounts.insert(std::make_pair("encryptwallet",0));
    mapLogParaFCounts.insert(std::make_pair("walletpassphrase",0));
    mapLogParaFCounts.insert(std::make_pair("walletpassphrasechange",0));
    mapLogParaFCounts.insert(std::make_pair("importprivkey",0));
    mapLogParaFCounts.insert(std::make_pair("signrawtransaction",-1));
}

void FC_InitRPCAllowedWhenWaitingForUpgradeSet()
{
...
void FC_InitRPCHelpMap()
{
    ...
    FC_InitRPCLogParaFCountMap();
    FC_InitRPCAllowedWhenWaitingForUpgradeSet();    
}

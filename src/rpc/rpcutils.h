...
#ifndef RPCFLOATCHAINUTILS_H
#define	RPCFLOATCHAINUTILS_H
...
#define FC_ASSET_KEY_UNCONFIRMED_GENESIS    1
#define FC_ASSET_KEY_VALID                  0
#define FC_ASSET_KEY_INVALID_TXID          -1
#define FC_ASSET_KEY_INVALID_REF           -2
#define FC_ASSET_KEY_INVALID_NAME          -3
#define FC_ASSET_KEY_INVALID_SIZE          -4
#define FC_ASSET_KEY_INVALID_EMPTY         -5

...
extern std::map<std::string, int> mapLogParaFCounts;
...
extern json_spirit::Value grantfroFCmd(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value revokefroFCmd(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value issuefroFCmd(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value issuemorefroFCmd(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value createfroFCmd(const json_spirit::Array& params, bool fHelp);

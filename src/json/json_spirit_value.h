...
namespace json_spirit
{
    ...
    typedef Config_map< std::string > FConfig;

    typedef FConfig::Value_type  mValue;
    typedef FConfig::Object_type mObject;
    typedef FConfig::Array_type  mArray;

    // typedefs for Unicode

#ifndef BOOST_NO_STD_WSTRING

    typedef Config_map< std::wstring > wFConfig;

    typedef wFConfig::Value_type  wmValue;
    typedef wFConfig::Object_type wmObject;
    typedef wFConfig::Array_type  wmArray;
